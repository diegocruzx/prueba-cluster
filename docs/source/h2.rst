...
Cluster con procesadores Intel Xeon familia Haswell.
...
Cluster con procesadores Intel Knights Landing MIC (Many Integrated Core).
...
:Red de Procesamiento: Intel Omnipath 100 Gbps (incluye Storage Local)
...
Cluster de última generación con capacidades de IA y cómputo acelerado.

Especificaciones Generales
--------------------------

:Sistema Operativo: Rocky Linux 8.7 (Green Obsidian)
:Nodos de Cálculo: 40 nodos Thin
:Total de Núcleos CPU: 960 núcleos
:Servidores GPU: 2 (arquitecturas Ampere A100 y L40)
...
El LNS cuenta con una infraestructura de red robusta y de alto rendimiento.
...
.. admonition:: Mejores Prácticas de Almacenamiento

   * Use el almacenamiento NVMe para trabajos con E/S intensiva
   * El sistema SAN es ideal para datos compartidos entre clusters
   * Configure respaldos automáticos de datos críticos
   * Archive resultados de largo plazo en la librería de cintas
